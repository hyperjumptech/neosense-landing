...
const features = [
  ...
  {
    name: 'Interval and threshold',
    summary: 'Be the first person to know when your systems are down.',
    description:
    ...
    icon: function IntervalAndThresholdIcon() {
      return (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
